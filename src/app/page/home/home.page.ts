...
import { CheckboxComponent } from "@Component/UI/checkbox/checkbox.component";
...
@Component({
    selector: 'page-home',
    standalone: true,
    imports: [TitleHeaderComponent, PreferenceComponent, DropdownComponent, InputComponent, CheckboxComponent],
